...
MODEL              = PWM_emulator
MODULES            = PWM_emulator_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE           = PWM_emulator.mk
MATLAB_ROOT        = E:/Applications/Matlab
ALT_MATLAB_ROOT    = E:/Applications/Matlab
MASTER_ANCHOR_DIR  = 
START_DIR          = E:/Facultate/Anul 2/II/IA/Examen/Subiectul 6
MATLAB_BIN         = E:/Applications/Matlab/bin
ALT_MATLAB_BIN     = E:/Applications/Matlab/bin
...
MEX_OPT_FILE       = -f E:/Applications/Matlab/rtw/c/tools/lcc-win64.xml
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 
DEFINES_CUSTOM     = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = PWM_emulatorlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/accel/PWM_emulator \
	-I$(START_DIR) \
